...
class BEW_Carousel_Products extends BEW_Settings {
    ...
    protected function register_controls() {
		...
		$this->get_title_typography( 'price_typography', '.product .price' );
		...
		$this->get_title_typography( 'del_price_typography', '.product .price del' );
		...
		$this->get_title_typography( 'button_typography', '.bew-elements-carousel-products a.add_to_cart_button, .bew-elements-carousel-products a.product_type_grouped, .bew-elements-carousel-products a.product_type_external, .bew-elements-carousel-products a.yith-wcqv-button' );
		...
		$this->get_normal_color( 'btn_txt_color', esc_html__( 'Text Color', 'bosa-elementor-for-woocommerce' ), '.bew-elements-carousel-products a.add_to_cart_button, .bew-elements-carousel-products a.product_type_grouped, .bew-elements-carousel-products a.product_type_external, .bew-elements-carousel-products a.yith-wcqv-button', 'color' );

		$this->get_normal_color( 'btn_bg_color', esc_html__( 'Background Color', 'bosa-elementor-for-woocommerce' ), '.bew-elements-carousel-products a.add_to_cart_button, .bew-elements-carousel-products a.product_type_grouped, .bew-elements-carousel-products a.product_type_external, .bew-elements-carousel-products a.yith-wcqv-button', 'background-color' );
		...
		$this->get_normal_color( 'btn_hov_txt_color', esc_html__( 'Text Color', 'bosa-elementor-for-woocommerce' ), '.bew-elements-carousel-products a.add_to_cart_button:hover, .bew-elements-carousel-products a.product_type_grouped:hover, .bew-elements-carousel-products a.product_type_external:hover, .bew-elements-carousel-products a.yith-wcqv-button:hover', 'color' );

		$this->get_normal_color( 'btn_hov_bg_color', esc_html__( 'Background Color', 'bosa-elementor-for-woocommerce' ), '.bew-elements-carousel-products a.add_to_cart_button:hover, .bew-elements-carousel-products a.product_type_grouped:hover, .bew-elements-carousel-products a.product_type_external:hover, .bew-elements-carousel-products a.yith-wcqv-button:hover', 'background-color' );

		$this->get_normal_color( 'btn_hov_border_color', esc_html__( 'Border Color', 'bosa-elementor-for-woocommerce' ), '.bew-elements-carousel-products a.add_to_cart_button:hover, .bew-elements-carousel-products a.product_type_grouped:hover, .bew-elements-carousel-products a.product_type_external:hover, .bew-elements-carousel-products a.yith-wcqv-button:hover', 'border-color' );
		...
		$this->get_border_attr( 'btn_border', '.bew-elements-carousel-products a.add_to_cart_button, .bew-elements-carousel-products a.product_type_grouped, .bew-elements-carousel-products a.product_type_external, .bew-elements-carousel-products a.yith-wcqv-button' );

		$this->get_border_radius( 'btn_radius', esc_html__( 'Border Radius', 'bosa-elementor-for-woocommerce' ), '.bew-elements-carousel-products a.add_to_cart_button, .bew-elements-carousel-products a.product_type_grouped, .bew-elements-carousel-products a.product_type_external, .bew-elements-carousel-products a.yith-wcqv-button', 'border-radius' );

		$this->get_margin( 'btn_margin', '.bew-elements-carousel-products a.add_to_cart_button, .bew-elements-carousel-products a.product_type_grouped, .bew-elements-carousel-products a.product_type_external, .bew-elements-carousel-products a.yith-wcqv-button' );

		$this->get_padding( 'btn_padding', '.bew-elements-carousel-products a.add_to_cart_button, .bew-elements-carousel-products a.product_type_grouped, .bew-elements-carousel-products a.product_type_external, .bew-elements-carousel-products a.yith-wcqv-button' );
